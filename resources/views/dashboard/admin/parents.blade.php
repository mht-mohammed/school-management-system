...
@section('content')
        ...
        <div style="background:#fff;padding:25px;border-radius:14px;width:90%;max-width:500px;max-height:90vh;overflow-y:auto;">
            ...
            <div class="form-group">
                ...
                <div style="display:flex;align-items:center;gap:12px;margin:5px 0 10px;">
                    ...
                    <span id="pRemoveAvatarBtn" style="display:none;cursor:pointer;color:#dc3545;font-weight:600;font-size:13px;" onclick="removeParentAvatar()">{{ __('🗑️ حذف') }}</span>
                </div>
            </div>
    ...
    <div id="childrenModal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:999;align-items:center;justify-content:center;">
        <div style="background:#fff;padding:25px;border-radius:14px;width:90%;max-width:500px;">
            ...
            list.forEach(p => {
                ...
                tbody.innerHTML += `<tr>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <button class="btn btn-sm" style="background:#dc3545;color:#fff;" onclick="deleteParent(${p.id},'${p.name}')">🗑️</button>
                    </td>
                </tr>`;
            });
        }
