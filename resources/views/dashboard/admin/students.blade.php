        ...
        <div style="background:#fff;padding:25px;border-radius:var(--radius-md);width:90%;max-width:500px;max-height:90vh;overflow-y:auto;">
            ...
            <div class="form-group"><label>{{ __('العنوان') }}</label><input id="editStudentAddress" style="width:100%;padding:10px;border:1px solid #ddd;border-radius:8px;margin:5px 0 10px;"></div>
                ...
                <div style="display:flex;align-items:center;gap:12px;margin:5px 0 15px;">
                    ...
                    <span id="sRemoveAvatarBtn" style="display:none;cursor:pointer;color:#b8232e;font-weight:600;font-size:13px;" onclick="removeStudentAvatar()">{{ __('🗑️ حذف') }}</span>
                </div>
            </div>
            ...
            list.forEach(s => {
                ...
                tbody.innerHTML += `<tr>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <button class="btn btn-sm" style="background:#b8232e;color:#fff;" onclick="deleteStudent('${s.id}', '${s.user?.name || ''}')">🗑️</button>
                    </td>
                </tr>`;
            });
        }
