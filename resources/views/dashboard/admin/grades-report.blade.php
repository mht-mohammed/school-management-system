        ...
        function loadReport() {
            ...
            apiFetch('/admin/grades-report?' + new URLSearchParams(params)).then(grades => {
                ...
                Object.entries(studentGroups).forEach(([stuId, subjects]) => {
                    ...
                    html += `<div style="background:#f8faff;border-radius:14px;padding:18px;border:1px solid #e0e8f0;">
                        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
                            ${stuAvatar ? `<img src="/storage/${stuAvatar}" style="width:36px;height:36px;border-radius:50%;object-fit:cover;">` : '<div style="width:36px;height:36px;border-radius:50%;background:#4a90d9;color:#fff;display:flex;align-items:center;justify-content:center;font-size:16px;">🎓</div>'}
