...
@section('content')
    ...
    <div id="studentsInSectionModal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:999;align-items:center;justify-content:center;">
        <div style="background:#fff;padding:25px;border-radius:var(--radius-md);width:90%;max-width:600px;max-height:85vh;overflow-y:auto;">
    ...
    <script>
        ...
        function renderGradeLevels() {
            ...
            allGradeLevels.forEach(gl => {
                ...
                container.innerHTML += `
                    <div style="border:1px solid #e0e0e0;border-radius:var(--radius-md);padding:16px;margin-bottom:14px;">
            ...
            if (unassigned > 0) {
                container.innerHTML += `
                    <div style="border:1px solid #ffc107;border-radius:var(--radius-md);padding:16px;margin-bottom:14px;background:#fffbe6;">
                        <div style="display:flex;justify-content:space-between;align-items:center;">
                            <h4 style="margin:0;">${__('⚠️ طلاب بدون شعبة')} <span style="color:#b8232e;font-weight:700;">${unassigned}</span></h4>
        ...
        function populateTeacherDropdown(gradeLevelId, selectedTeacherId) {
            ...
            if (!teachersList.length) {
                sel.innerHTML += '<option value="" disabled>' + __('لا يوجد معلمون') + '</option>';
            }
        }
