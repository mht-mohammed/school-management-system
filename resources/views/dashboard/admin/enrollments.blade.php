...
@section('content')
    <style>
        ...
        .req-card { border:1px solid #e8e8e8; border-radius:var(--radius-md); padding:16px 20px; margin-bottom:12px; background:#fff; transition:all 0.2s; }
        ...
        .req-card.rejected { border-right:4px solid #b8232e; }
        ...
        .credentials-modal .box { background:#fff; border-radius:var(--radius-lg); padding:30px; width:90%; max-width:450px; text-align:center; }
        ...
        .action-btn.approve { background:#e1f7e7; color:#157a35; }
        .action-btn.approve:hover { background:#28a745; color:#fff; }
        .action-btn.reject { background:#fde3e3; color:#b8232e; }
        .action-btn.reject:hover { background:#b8232e; color:#fff; }
