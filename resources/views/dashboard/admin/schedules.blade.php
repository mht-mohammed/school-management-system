...
@section('content')
    <div class="card">
        ...
        <div style="margin-bottom:15px;display:flex;gap:10px;flex-wrap:wrap;align-items:center;">
            ...
            <button class="btn" style="background:#b8232e;color:#fff;" onclick="clearAllSchedules()">{{ __('🗑️ إفراغ الجداول') }}</button>
        ...
        <div id="scheduleContainer" style="display:none;">
            ...
            <div style="overflow-x:auto;">
                <table id="scheduleGrid" style="width:100%;border-collapse:collapse;">
                    <thead>
                        <tr style="background:var(--blue-main);color:#fff;">
    ...
    <div id="cellModal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:999;align-items:center;justify-content:center;">
        <div style="background:#fff;padding:25px;border-radius:var(--radius-md);width:90%;max-width:420px;">
            ...
            <div id="cellTeacherWarning" style="display:none;padding:10px 14px;background:#fde3e3;border:1px solid #b8232e;border-radius:8px;color:#b8232e;font-size:13px;font-weight:600;margin-bottom:12px;"></div>
            ...
            <div style="display:flex;gap:10px;">
                ...
                <button class="btn" style="background:#b8232e;color:#fff;" id="deleteCellBtn" onclick="deleteCell()">{{ __('🗑️ حذف') }}</button>
    ...
    <script>
        ...
        function renderGrid() {
            ...
            currentGrid.forEach(row => {
                ...
                dayHeader.style.cssText = 'padding:10px;font-weight:700;background:var(--blue-50);border:1px solid #e0e0e0;text-align:center;';
        ...
        function renderSubjectSummary() {
            ...
            div.innerHTML = '<strong style="margin-left:8px;">' + __('توزيع المواد:') + '</strong> ' +
                entries.map(([name, count]) =>
                    `<span style="display:inline-block;padding:3px 10px;border-radius:20px;background:#e8f0fe;margin:2px 4px;font-size:13px;">${subjectName(name)} <strong style="color:var(--blue-main);">×${count}</strong></span>`
                ).join('');
        }
