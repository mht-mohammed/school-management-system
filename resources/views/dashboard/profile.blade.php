...
<div class="card" style="max-width:600px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:25px;" id="avatarSection">
        ...
        <span id="removeAvatarBtn" style="display:none;cursor:pointer;color:#dc3545;font-weight:700;font-size:14px;margin-right:15px;" onclick="removeAvatar()">🗑️ {{ __('حذف الصورة') }}</span>
...
<script>
    ...
    apiFetch('/user').then(u => {
        ...
        if (u.role === 'teacher' && u.teacher) {
            ...
            document.getElementById('displaySalary').textContent = u.teacher.salary ? toArabicNum(u.teacher.salary) + __(' شيكل') : __('غير محدد');
